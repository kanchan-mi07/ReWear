...
export default function ItemDetailPage() {
  ...
  const [showSwapChat, setShowSwapChat] = useState(false)
  ...
  const isUserInSwap = item.status === "reserved" && activeSwap && user && (activeSwap.requester_id === user.id || activeSwap.responder_id === user.id)
